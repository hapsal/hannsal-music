...
export default function Footer() {
  ...
  return (
    <footer className="bg-base-200 pt-12 pb-6">
      <div className="max-w-5xl mx-auto px-4"> {/* Matches navbar width */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://instagram.com/hannsalmusic" target="_blank" rel="noopener noreferrer" className="btn btn-circle btn-sm btn-ghost">
              ...
              <a href="https://www.youtube.com/@HANNSAL" target="_blank" rel="noopener noreferrer" className="btn btn-circle btn-sm btn-ghost">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" />
                </svg>
              </a>
              <a href="https://open.spotify.com/artist/1IiKG3c6yyYDTjyv7nRthD" target="_blank" rel="noopener noreferrer" className="btn btn-circle btn-sm btn-ghost">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
